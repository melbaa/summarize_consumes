...
def process_tree(app: App, line: str, tree: LineTree):
    ...
    #    return True
        ...
        app.auto_attack_stats.add_miss(attacker)
        return True
    ...
    #    return True
        ...
        # slayer = subtree.slayer
        return True
    elif subtree.data == TreeType.CREATES_LINE:
        # creator = subtree.creator
        # item = subtree.item
        return True
